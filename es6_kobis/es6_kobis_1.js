    ...
    "dailyBoxOfficeList": [
      {
        ...
        "rankOldAndNew": "OLD",
        "movieCd": "20224667",
        "movieNm": "잠",       //kobic.boxOfficeResult.dailyBoxOfficeList[0].movieNm 
        "openDt": "2023-09-06",
        "salesAmt": "735086507",
        "salesShare": "44.9",
...
/* 
//일별 박스오피스 출력 - 순위, 영화제목, 누적관객수, 누적매출액
console.log(kobic.boxOfficeResult.dailyBoxOfficeList[0].rank ); //순위
console.log(kobic.boxOfficeResult.dailyBoxOfficeList[0].movieNm ); //영화제목
console.log(kobic.boxOfficeResult.dailyBoxOfficeList[0].audiAcc ); //누적관객수 
console.log(kobic.boxOfficeResult.dailyBoxOfficeList[0].salesAcc ); //누적 매출액
 */
...
<div>
  <p>
    순위 : ${boxArr.rank}, 영화제목 : ${boxArr.movieNm}, 누적관객수 : ${boxArr.audiAcc}, 누적매출액 : ${boxArr.salesAcc}
  </p>
</div>

function kb(dailyBoxOfficeList) {
  return `
  ${dailyBoxOfficeList.map(dailyBoxOfficeList)=>`<span>${dailyBoxOfficeList}</span>`.join}
  `
}
` */
